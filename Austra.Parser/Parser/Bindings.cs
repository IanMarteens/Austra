...
internal sealed class Bindings
{
    ...
    private readonly FrozenDictionary<Type, Member[]> members =
        new Dictionary<Type, Member[]>()
        {
            ...
            [typeof(LMatrix)] = [
                ...
                new("sum", "Gets the sum of all cells"),
            ...
            [typeof(NVector)] = [
                ...
                new("last", "Gets the last item from the vector"),
                new("length", "Gets the number of items"),
                new("longProd", "Gets the product of all values as a long integer"),
                new("max", "Gets the maximum  value"),
                new("mean", "Gets the mean value"),
                new("min", "Gets the minimum value"),
                new("plot", "Plots this vector"),
    ...
    private readonly FrozenDictionary<string, MethodList> classMethods =
        new Dictionary<string, MethodList>()
        {
            ...
            ["matrix.new"] = new(
                ...
                typeof(Matrix).MD(typeof(Csv), typeof(int[]))),
            ["matrix.rows"] = new(
            ...
            ["series.new"] = new(
                ...
                typeof(Series).MD(nameof(Series.FromCsv), typeof(string), typeof(Csv), typeof(string), typeof(string))),
            ["spline.new"] = new(
    ...
    private readonly FrozenDictionary<TypeId, MethodInfo> allProps =
        new Dictionary<TypeId, MethodInfo>()
        {
            ...
            [new(typeof(LMatrix), "sum")] = typeof(LMatrix).Get(nameof(LMatrix.Sum)),
            ...
            [new(typeof(Matrix), "sum")] = typeof(Matrix).Get(nameof(Matrix.Sum)),
            ...
            [new(typeof(NSequence), "longproduct")] = typeof(NSequence).Get(nameof(NSequence.LongProduct)),
            ...
            [new(typeof(NVector), "longprod")] = typeof(NVector).Get(nameof(NVector.LongProduct)),
            [new(typeof(NVector), "longproduct")] = typeof(NVector).Get(nameof(NVector.LongProduct)),
            ...
            [new(typeof(RMatrix), "inverse")] = typeof(RMatrix).Get(nameof(RMatrix.Inverse)),
            ...
            [new(typeof(RMatrix), "sum")] = typeof(RMatrix).Get(nameof(RMatrix.Sum)),
